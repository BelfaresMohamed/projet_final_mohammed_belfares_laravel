...
use App\Http\Controllers\MaillletterController;
...
Route::get("/show/{produit}", [SingleProductController::class, "showitem"])->name('show.produit');

Route::get('/contact', function () {
    return view('frontend.contact');
})->name('contact');

Route::get('/contact/boite', function () {
...
Route::get('/boite',[HomeController::class,'boite'])->name(('boite.index'));
...
Route::post('/send_mail',[MaillletterController::class, 'store'])->name('mail.store');
